...
plot(subhousepower$Time, subhousepower$Global_active_power, type = "l",xlab = "", ylab = "Global Active Power")

plot(subhousepower$Time, subhousepower$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(subhousepower$Time, subhousepower$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
